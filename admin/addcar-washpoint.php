...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php" style="color: black;">Home</a><i class="fa fa-angle-right"></i>Add Service Point </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label text-white">Contact Number</label>
									<div class="col-sm-8">
			...
			<div class="col-sm-8 col-sm-offset-2">
				<button type="submit" name="submit" class="btn-primary btn bg-dark">Add</button>
