...
<?php include('includes/header.php');?>
		...
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php" style="color: black;">Home</a> <i class="fa fa-angle-right"></i></li>
            </ol>
		<div class="four-grids">

			<a href="all-bookings.php" target="_blank">
					<div class="col-md-3 four-grid">
						<div class="four-agileits" style="background-color: #242424;">
							<div class="icon">
...
<a href="new-booking.php" target="_blank">
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo" style="background-color: #242424;">
							<div class="icon">
								<i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i>
							</div>
							<div class="four-text">
...
$newbookings=$query1->rowCount();
		...
		<a href="completed-booking.php" target="_blank">
					<div class="col-md-3 four-grid">
						<div class="four-wthree" style="background-color: #242424;">
							<div class="icon">
							<i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i>
							</div>
							<div class="four-text">
...
$completedbookings=$query3->rowCount();
	...
	<a href="manage-enquires.php" target="_blank">
			<div class="col-md-3 four-grid">
						<div class="four-w3ls" style="background-color: #242424;">
							<div class="icon">
