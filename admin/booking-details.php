...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php"  style="color: black;">Home</a><i class="fa fa-angle-right"></i>Manage New Bookings</li>
            </ol>
<div class="agile-grids">	
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h1 style="color: black;">Bookings Details #<?php echo $_GET['bookingid'];?></h2>
					    <table id="table">
...
<?php if($result->adminRemark==''): ?>
	<tr>
		<td colspan="3">
	<button data-toggle="modal" data-target="#myModal" class="bg-dark text-white btn">Take Action</button>
</td>
</tr>
<?php  else:?>

<tr>
	<td colspan="4" style="color:black; font-size:22px; text-align:center; font-weight:bold;">Admin Details</td>
</tr>
