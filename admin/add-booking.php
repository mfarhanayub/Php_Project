...
<html>
<head>
<title> Add Car Service Booking</title>
...
<?php include('includes/header.php');?>
	...
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php" style="color: black;">Home</a><i class="fa fa-angle-right"></i>Add Car Service Booking </li>
            </ol>
 	<div class="grid-form">
 
  <div class="grid-form1" style="background-color: #242424;">
  	       <h3 style="color: white;">Add Car Service Booking</h3>

  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="washingpoint" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label text-white">Package Type</label>
									<div class="col-sm-8">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label text-white">Service Point</label>
									<div class="col-sm-8">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label text-white">Full Name</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label text-white">Mobile No</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label text-white">Service Date</label>
									<div class="col-sm-8">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label text-white">Service Time</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label text-white">Message (if any)</label>
									<div class="col-sm-8">
			...
			<div class="col-sm-8 col-sm-offset-2">
				<button type="submit" name="book" class="btn-primary btn bg-dark">Add</button>
