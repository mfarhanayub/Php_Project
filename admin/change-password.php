...
<?php include('includes/header.php');?>
	...
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php"  style="color: black;">Home</a><i class="fa fa-angle-right"></i>Change Password</li>
            </ol>
 	<div class="grid-form" style="background-color: #242424;">
  ...
  <div class="panel-body">
	...
	<div class="form-group">
				...
				<button type="submit" name="submit" class="btn bg-dark text-white">Submit</button>
