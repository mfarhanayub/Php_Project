...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php" style="color: black;">Home</a><i class="fa fa-angle-right"></i>Manage Completed Bookings</li>
            </ol>
<div class="agile-grids" >	
				...
				<div class="agile-tables" style="background-color: #242424;">
					<div class="w3l-table-info">
					  <h2 style="color: white;">Completed Bookings</h2>
					    <table id="table">
						<thead>
						  <tr>
						  <th>Booking No.</th>
